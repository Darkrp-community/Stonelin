...
/obj/item/clothing/cloak/chasuble
	...
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_HALF_ELF, SPEC_ID_TIEFLING, SPEC_ID_AASIMAR, "abyssariad")
...
//	body_parts_covered = ARMS|CHEST
	...
	allowed_sex = list(MALE, FEMALE)
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_HALF_ELF, SPEC_ID_TIEFLING, SPEC_ID_ELF, SPEC_ID_AASIMAR, "abyssariad")
...
/obj/item/clothing/cloak/cape/puritan
	...
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_HALF_ELF, SPEC_ID_TIEFLING, SPEC_ID_ELF, SPEC_ID_DWARF, SPEC_ID_AASIMAR, "abyssariad")
