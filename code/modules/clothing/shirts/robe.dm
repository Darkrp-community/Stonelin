...
/obj/item/clothing/shirt/robe/wizard
	...
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_TIEFLING, SPEC_ID_AASIMAR, "abyssariad")
	sellprice = 100
...
/obj/item/clothing/shirt/robe/nun
	icon_state = "nun"
	item_state = "nun"
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_TIEFLING, SPEC_ID_DROW, SPEC_ID_ELF, SPEC_ID_HALF_ELF, SPEC_ID_DWARF, SPEC_ID_AASIMAR, "abyssariad")
...
/obj/item/clothing/shirt/robe/archivist
	...
	allowed_race = list(SPEC_ID_HUMEN, SPEC_ID_TIEFLING, SPEC_ID_ELF, SPEC_ID_AASIMAR, "abyssariad")
	color = null
	sellprice = 100
