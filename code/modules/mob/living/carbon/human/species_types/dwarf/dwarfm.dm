...
/datum/species/dwarf/mountain
	...
	specstats_m = list(STATKEY_STR = 1, STATKEY_PER = -1, STATKEY_INT = 0, STATKEY_CON = 2, STATKEY_END = 3, STATKEY_SPD = -2, STATKEY_LCK = 0)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 0, STATKEY_INT = 0, STATKEY_CON = 2, STATKEY_END = 3, STATKEY_SPD = -1, STATKEY_LCK = 0)
