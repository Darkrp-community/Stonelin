...
#define RACES_PLAYER_MANLIEST list(\
	SPEC_ID_HUMEN,\
	SPEC_ID_DWARF,\
)

#define RACES_PLAYER_DELVESALLOWED list(\
	SPEC_ID_HUMEN,\
	SPEC_ID_DWARF,\
	SPEC_ID_AASIMAR,\
	SPEC_ID_ELF,\
...
#define RACES_PLAYER_TIEFSALLOWED list(\
	SPEC_ID_HUMEN,\
	SPEC_ID_DWARF,\
	SPEC_ID_AASIMAR,\
	SPEC_ID_ELF,\
...
#define ALL_STONEKEEP_RACES_NORMALSPRITE list(\
	SPEC_ID_HUMEN,\
	SPEC_ID_AASIMAR,\
	SPEC_ID_ELF,\
	SPEC_ID_HALF_ELF,\
