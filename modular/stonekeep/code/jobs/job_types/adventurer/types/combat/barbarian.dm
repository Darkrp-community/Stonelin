...
/datum/outfit/job/sk/adventurer/barbarian/pre_equip(mob/living/carbon/human/H)
	...
	switch(weapontype)
		if("Sword")
			...
			H.mind?.adjust_skillrank(/datum/skill/combat/swords, 1, TRUE)//to guarantee average skill on a weapon + skilled in another
		if("Club")
			beltr = /obj/item/weapon/mace/spiked//buffed to a iron mace
